import cv2
from Script.Common.utils import print_matInfo


title1, title2 = 'gray2gray', 'gray2color'
gray2gray = cv2.imread("C:/Users/64527/PycharmProjects/pythonProject/venv/Img/read_color.jpg", cv2.IMREAD_GRAYSCALE)
gray2color = cv2.imread("C:/Users/64527/PycharmProjects/pythonProject/venv/Img/read_color.jpg", cv2.IMREAD_COLOR)
